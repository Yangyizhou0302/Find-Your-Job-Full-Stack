...
public class MonkeyLearnClient {
	private static final String API_KEY = "dd5d48c274b5bf0e3f42c08191c46d18ebe58272";
	...
	// transform JSONArray to List<List<>>
	private static List<List<String>> getKeywords(JSONArray mlResultArray) {
		...
		for (int i = 0; i < mlResultArray.size(); ++i) {
			...
			JSONArray keywordsArray = (JSONArray) mlResultArray.get(i);// input keyword
